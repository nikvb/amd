...
#
# Generated by tools/gen-installer.sh from commit 061cbdc-dirty on 2026-09-22 (installer version 061cbdc). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='061cbdc'
AMD_WS_SOURCE_COMMIT='061cbdc-dirty'
MODULE=app_amd_ws
APP=AMD_WS
