...
#
# Generated by tools/gen-installer.sh from commit f8c8bef on 2026-09-24 (installer version f8c8bef). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='f8c8bef'
AMD_WS_SOURCE_COMMIT='f8c8bef'
MODULE=app_amd_ws
APP=AMD_WS
