...
#
# Generated by tools/gen-installer.sh from commit f24cd5c-dirty on 2026-09-22 (installer version f24cd5c). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='f24cd5c'
AMD_WS_SOURCE_COMMIT='f24cd5c-dirty'
MODULE=app_amd_ws
APP=AMD_WS
