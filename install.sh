...
#
# Generated by tools/gen-installer.sh from commit 8ee48cc on 2026-09-22 (installer version 8ee48cc). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='8ee48cc'
AMD_WS_SOURCE_COMMIT='8ee48cc'
MODULE=app_amd_ws
APP=AMD_WS
