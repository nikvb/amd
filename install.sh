...
#
# Generated by tools/gen-installer.sh from commit c54e7fc-dirty on 2026-09-23 (installer version c54e7fc). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='c54e7fc'
AMD_WS_SOURCE_COMMIT='c54e7fc-dirty'
MODULE=app_amd_ws
APP=AMD_WS
