...
#
# Generated by tools/gen-installer.sh from commit 1717df7-dirty on 2026-09-24 (installer version 1717df7). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='1717df7'
AMD_WS_SOURCE_COMMIT='1717df7-dirty'
MODULE=app_amd_ws
APP=AMD_WS
