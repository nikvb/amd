...
#
# Generated by tools/gen-installer.sh from commit f78c231 on 2026-09-24 (installer version f78c231). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='f78c231'
AMD_WS_SOURCE_COMMIT='f78c231'
MODULE=app_amd_ws
APP=AMD_WS
