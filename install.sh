...
#
# Generated by tools/gen-installer.sh from commit b905a47-dirty on 2026-09-23 (installer version b905a47). DO NOT EDIT: run 'make installer'.
#
...
AMD_WS_INSTALLER_VERSION='b905a47'
AMD_WS_SOURCE_COMMIT='b905a47-dirty'
MODULE=app_amd_ws
APP=AMD_WS
